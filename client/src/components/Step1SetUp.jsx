...
function Step1SetUp({ onStart, selectedMode }) {
  ...
  const getInitialMode = () => {
    if (selectedMode === "hr") return "HR";
    if (selectedMode === "confidence") return "Confidence";
    return "Technical";
  };
  ...
  const handleStart = async () => {
    if (!role || !experience || !mode) {
      alert("Please fill role, experience, and mode.");
      return;
    }
    ...
    try {
      ...
      console.log("generate questions response:", result.data);
        ...
        >
          ...
          <div className='space-y-6'>
            ...
            >
              ...
              <option value="Confidence">Confidence Detection</option>
            </select>
