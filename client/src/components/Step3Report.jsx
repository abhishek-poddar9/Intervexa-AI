...
function Step3Report({ report, selectedMode }) {
  if (!report) {
    return (
  ...
  const downloadPDF = () => {
    ...
    doc.text(`Interview Mode: ${activeMode}`, pageWidth / 2, currentY, {
      align: "center",
    });
      ...
      <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
        <div className='md:mb-10 w-full flex items-start gap-4 flex-wrap'>
          ...
          <div>
            ...
            <div className={`mt-4 inline-flex px-4 py-2 rounded-full text-sm font-semibold ${getModeBadgeClasses()}`}>
              {activeMode} Mode Report
            </div>
          </div>
        </div>
